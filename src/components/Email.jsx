...
import { Page, Card, FormLayout, TextField, Layout, Button } from '@shopify/polaris';
...
export function Email() {
    ...
    return (
        <Page title="Email">
            <Layout>
                {skipToContentTarget}
                <Layout.AnnotatedSection title="Email Configurations" description="Please add your email for sending notify">
                    <Card sectioned>
                        <FormLayout>
                            <TextField disabled={loadingUrl} label="Email" value={emailFieldValue} onChange={handleUrlFieldChange} placeholder={'www.shopify.com'} />
